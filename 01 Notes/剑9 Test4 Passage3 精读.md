...
- 套题：Cambridge IELTS 9
- 位置：Test 4 Passage 3
- 标题：The Development of Museums
...
| 原句 | 结构拆分 | 译文 | 备注 |
| --- | --- | --- | --- |
| The conviction that historical relics provide infallible testimony about the past is rooted in the nineteenth and early twentieth centuries, when science was regarded as objective and value free. | 主干：`The conviction ... is rooted in ...`；`that historical relics ...` 是同位语从句，解释 conviction 内容；`when science was regarded ...` 是时间状语从句。 | 人们坚信历史遗物能够为过去提供绝对可靠的证据，这种观念根植于十九世纪和二十世纪初，当时科学被视为客观且不带价值判断。 | A 段核心论点句，抓 `conviction` 和 `be rooted in`。 |
| Such developments have been criticized as an intolerable vulgarisation, but the success of many historical theme parks and similar locations suggests that the majority of the public does not share this opinion. | 主干：`Such developments have been criticized ...` + `the success ... suggests that ...`；前半句说批评，后半句说大众未必认同；`that the majority ...` 是宾语从句。 | 这些发展被批评为一种无法容忍的庸俗化，但许多历史主题公园及类似场所的成功说明，大多数公众并不认同这种看法。 | B 段常见转折句，做题时要看清 `critics` 和 `the public` 立场相反。 |
| This development is a response to market forces and, although museums and heritage sites have a special, rather distinct, role to fulfil, they are also operating in a very competitive environment, where visitors make choices on how and where to spend their free time. | 主干：`This development is a response to market forces`；`although ...` 让步从句说明博物馆有特殊职责；后面主句是 `they are also operating ...`；`where visitors ...` 修饰 environment。 | 这种发展是对市场力量的回应。尽管博物馆和遗产地有其特殊且相当独特的职责要履行，但它们同样处在一个竞争非常激烈的环境中，参观者会自行选择如何以及去哪里花费闲暇时间。 | D 段最关键的逻辑句，说明商业压力来源。 |
| Those who are professionally engaged in the art of interpreting history are thus in a difficult position, as they must steer a narrow course between the demands of 'evidence' and 'attractiveness', especially given the increasing need in the heritage industry for income-generating activities. | 主干：`Those who ... are thus in a difficult position`；`as ...` 说明原因；`between the demands of ...` 表示在两种要求之间平衡；`given ...` 补充现实压力。 | 因此，那些以诠释历史为专业工作的人处境艰难，因为他们必须在“证据”和“吸引力”的要求之间小心拿捏，尤其是在遗产行业对创收活动需求日益增加的情况下。 | 这句直接概括全文核心矛盾。 |
| It could be claimed that in order to make everything in heritage more 'real', historical accuracy must be increasingly altered. | 主干：`It could be claimed that ...`；`in order to make ... more 'real'` 表目的；`historical accuracy must be increasingly altered` 是真正结论。 | 可以说，为了让遗产展示中的一切显得更加“真实”，历史准确性反而必须越来越多地被改动。 | E 段反讽句，`real` 和 `accuracy` 是反向关系。 |
| Human bias is inevitable, but another source of bias in the representation of history has to do with the transitory nature of the materials themselves. | 主干：`Human bias is inevitable`；后半句 `another source of bias ... has to do with ...` 说明另一类偏差来源；`of the materials themselves` 强调材料本身。 | 人的偏见不可避免，但历史再现中的另一种偏差来源，与材料本身短暂易逝的性质有关。 | F 段总领句，提示偏差不只来自人，也来自材料留存本身。 |
...
- P1：传统博物馆长期被视为客观真实的知识空间，但这种“实物天然真实”的观念其实值得怀疑。
- P2：现代博物馆越来越强调体验感、互动性和娱乐性，但这种趋势也遭到批评。
- P3：博物馆、遗产地和主题公园之间的边界正在模糊，展示方式互相借鉴。
- P4：博物馆既有知识职责，也要面对市场竞争，因此必须在真实性和吸引力之间平衡。
- P5：为了让历史看起来更“真实”，展示往往会按当代人的理解去改写历史。
- P6：历史材料本身留存不完整，这也会导致博物馆呈现出系统性偏差。

## 今日进度

- [x] 创建精读笔记
- [x] 收录短语 `steer a narrow course`
- [x] 根据截图补充 A-F 段高亮词
- [x] 根据截图补充 6 个长难句
- [ ] 复盘错题
